...
interface ResponseInterface extends MessageInterface, StatusCodeInterface
{
     ...
     *
     * Because a reason phrase is not a required element in a response status line, the reason phrase value MAY be null.
     * Implementations MAY choose to return the default RFC 7231 recommended reason phrase (or those listed in the IANA
     * HTTP Status Code Registry) for the response's status code.
     *
