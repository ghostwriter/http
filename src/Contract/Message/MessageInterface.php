 ...
 *
 * Messages are considered immutable; all methods that might change state MUST be implemented such that they retain the
...
interface MessageInterface
{
     ...
     *
     * // Represent the headers as a string foreach ($message->getHeaders() as $name => $values) { echo $name . ": " .
     * implode(", ", $values); }
     *
     * // Emit headers iteratively: foreach ($message->getHeaders() as $name => $values) { foreach ($values as $value) {
     ...
     * instance that has the new header and/or value.
     *
